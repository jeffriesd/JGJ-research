...
not contain all System F types, and in fact is not impredicative, so a
set-based parametric model is not {\em a priori} precluded. In fact,
the local finite presentability of $\set$ makes it an obvious choice
for interpreting nested types. We return to this point in
