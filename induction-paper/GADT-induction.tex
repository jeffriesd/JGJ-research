...
by analyzing the following concrete example.
\begin{equation}
\begin{array}{l}
...
An induction rule for $\mathsf{G}$ is a term
\begin{multline}
...
\[
\mathsf{p = DIG\,P\,pc\,(G\,b)\,(P\,b\,Q_b)\,x\,q}
\]
...
In this section we generalize the approach taken in the previous examples
