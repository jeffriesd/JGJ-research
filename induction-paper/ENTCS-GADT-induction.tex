...
%, so, in particular, the unit and empty types, $\mathsf{1}$ and
%$\mathsf{0}$,
...
$\mathsf{H}$.
%, and by giving an inductive definition when $\mathsf{H}$
%is an ADT or a nested type.
...
%We want a proof
%\[
%  \mathsf{getTypeProof : \forall \, (A : Set) \to LTerm\,A \to Maybe \, (LType \, A)} \\
%\]
