...
\begin{align*}
  ...
  \oCPOsem{\Gamma;\Phi \vdash (\Lan^{\ol{\alpha}}_{\ol{K}}
    F)\ol{A}}\pi_2 \rho\\
  &\hspace{0.3in}|~( (\eta_1)_{\ol{\oCPORsem{\Gamma;\Phi \vdash A}\pi_1
    \rho}} t_1,  (\eta_2)_{\ol{\oCPORsem{\Gamma;\Phi \vdash A}\pi_2
    \rho}} t_2) \in\\
  &\hspace{0.5in} (\textit{Lan}_{\ol{\oCPORsem{\Gamma; \ol\alpha \vdash
          K}\rho[\ol{\alpha := \Eq_{\_}}]}} \oCPORsem{\Gamma; \Phi, \ol\alpha
      \vdash F}\rho[\ol{\alpha := \Eq_{\_}}]) \ol{\oCPORsem{\Gamma; \Phi
        \vdash A}\rho} \}\\
\end{align*}
\end{dfn}
