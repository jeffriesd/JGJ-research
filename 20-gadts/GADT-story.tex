...
%    there is no mechanism in  Haskell for enforcing this}.}
%
%  be functorial --- i.e., to preserve identity functions and function
%  composition --- even though satisfaction of these properties
this is not
