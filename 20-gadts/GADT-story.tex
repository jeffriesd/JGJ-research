...
type can either be taken as primitive or
%, in a higher-kinded calculus such as $F\omega$,
can be represented by its own Church encoding
...
Note that Seq has no syntactic map (because Pair doesn't), i.e., is
not an instance of the Functor class, and is not required to in this
representation.
