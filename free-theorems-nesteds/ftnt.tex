...
\item An object of $\rel$ is a triple $(A,B,R)$ where $R$ is a
  relation between the objects $A$ and $B$ in $\set$. We write $R :
  \rel(A,B)$ when convenient.
...
When convenient we identify a $0$-ary relation transformer
$[1,(A,B,R)]$ with the relation $(A,B,R)$. We may also write $F^0$ and
$F^1$ for $\pi_1 F$ and $\pi_2 F$. We extend these conventions to
