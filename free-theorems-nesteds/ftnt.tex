...
{\color{blue} $\alpha$ vs. $\tau$. Strong vs. weak IEL?}
...
\llbracket \Gamma;\Phi \,|\, \Delta \vdash \tin :
...
\item $\Gamma; \Phi~|~\Delta \vdash (L_{\ol{\alpha}}x.t)_{\ol{\tau}}s
  = t [\ol{\alpha := \tau}][x := s]$
\item {\color{blue} $\fold\,k\,(\tin\,t) = k\, (map\,(\fold\,k) t)$????}
\end{itemize}
The set and relational interpretations of terms therefore respect the
...
\begin{itemize}  
\item Need this conversion rule: $\fold\,k\,(\tin\,t) =
  k\,(\map\,(\fold\,k)\,t)$?
