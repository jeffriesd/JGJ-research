...
{\color{red} Analogous changes here to those before Def 9 and in Def 9.}
...
\begin{equation*}
\lambda \ol{B}. \lambda \ol{C}. \setsem{\Gamma; \ol{\alpha},
...
\id_{\rho}[\ol{\beta := f}] [\ol{\gamma := g}][\phi := \lambda
  \ol{A}. \setsem{\Gamma; \ol{\beta}, \ol{\gamma} \vdash F} \id_{\rho
    [\ol{\beta := B}]} [\ol{\gamma := g}]] \\ 
=& \setsem{\Gamma; \phi, \ol{\alpha}, \ol{\gamma} \vdash H} (\id_{\rho
  [\ol{\gamma := C'}] [\phi := \lambda \ol{A}. \setsem{\Gamma;
    ...
    [\ol{\gamma := C'}]]} [\ol{\beta := f}] \\
&\hspace{3em} \circ \id_{\rho [\ol{\beta := B}] [\phi := \lambda
    \ol{A}. \setsem{\Gamma; \ol{\beta}, \ol{\gamma} \vdash F} \rho
       [\ol{\beta := A}] [\ol{\gamma := C'}]]} [\ol{\gamma := g}] \\
&\hspace{3em} \circ \id_{\rho [\ol{\beta := B}] [\ol{\gamma := C}]}
...
\id_{\rho [\ol{\beta := A}]} [\ol{\gamma := g}] \circ \lambda
\ol{B}.\eta_{\ol{B}, \ol{C}} \\  
...
\ol{B}. \setsem{\Gamma; \ol{\beta}, \ol{\gamma} \vdash F} \rho
   [\ol{\beta := B}]) \ar[d, "{ \lambda \ol{A}. \eta_{\ol{A}, \ol{C'}}
     }" description] \\
...
&& T^{\set}_{\rho [\ol{\gamma := C'}]} (\lambda \ol{B}.\setsem{\Gamma; \ol{\beta},
  \ol{\gamma} \vdash F} \rho [\ol{\beta := B}] ) \ar[d, "{ \lambda
