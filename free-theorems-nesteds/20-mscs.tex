...
This paper extends the conference paper~\cite{jgj21} by including
proofs of all theorems, as well as more examples. The discussion of
GADTs in Section~\ref{sec:GADTs} is also entirely new.
