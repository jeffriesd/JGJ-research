...
\title[Parametricity for Primitive
  Nested Types and GADTs]{Parametricity for Primitive
...
\author[P.~Johann]{Patricia Johann}	%required
\address{Appalachian State University}	%required
\email{johannp@appstate.edu}  %optional
%\thanks{thanks 1, optional.}	%optional

\author[E.~Ghiorzi]{Enrico Ghiorzi}	%optional
\address{Appalachian State University}	%optional
\email{ghiorzie@appstate.edu}  %optional
%\thanks{thanks 2, optional.}	%optional

\author[D.~Jeffries]{Daniel Jeffries}	%optional
\address{Appalachian State University}	%optional
