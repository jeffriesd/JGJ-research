...
theorems for programs over nested types. {\color{red} Add ainfo about
...
not appear in $G$, or must have arity $0$, in which case $\ol\alpha$
must be empty, if $\phi$ appears in $G$, and
