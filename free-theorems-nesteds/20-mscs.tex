...
\title[Parametricity for Primitive Nested Types and
  GADTs]{Parametricity for Primitive Nested Types}
...
This paper extends the conference paper~\cite{jgj21} of the same name
by including more exposition, proofs of all theorems, and more
examples. In addition, the discussion of parametricity for GADTs in
Section~\ref{sec:GADTs} is entirely new.
...
%$[[\rel^k,\rel],[\rel^k,\rel]]$. 
$[RT_k,RT_k]$. 
Its action on an object $\rho \in
...
Thus, if $L$ were a restriction of 
$\setsem{\Gamma; \Phi,\ol\alpha
\vdash (\Lan^{\ol\alpha}_{\ol K} F){\ol \alpha}}\rho[\Phi, \ol \alpha := \ol N, -]$, 
if the functorial
action of $L$ were a restriction of that of $\setsem{\Gamma;
\Phi,\ol\alpha \vdash (\Lan^{\ol\alpha}_{\ol K} F){\ol \alpha}}\rho[\Phi, \ol \alpha := \ol N, -]$, 
and if $L(\ol{\setsem{\Gamma;\ol\alpha \vdash K}\rho [\ol{\alpha := A}]})$
were to contain $\setsem{\Gamma;\emptyset~|~\emptyset \vdash \int_{\ol
...
$\setsem{\Gamma; \Phi,\ol\alpha \vdash (\Lan^{\ol\alpha}_{\ol K} F){\ol \alpha}}
\rho[\Phi, \ol \alpha := \ol N, -]$.
...
Thus, if $L$ were a restriction of $\setsem{\Gamma; \Phi,\ol\alpha
  \vdash (\Lan^{\ol\alpha}_{\ol K} F){\ol K}}\rho$, if the functorial
action of $L$ were a restriction of that of $\setsem{\Gamma;
  \Phi,\ol\alpha \vdash (\Lan^{\ol\alpha}_{\ol K} F){\ol K}}\rho$, and
if $L(\ol{\setsem{\Gamma;\ol\alpha \vdash K}\rho \ol N \, \ol A})$
were to contain $\setsem{\Gamma;\emptyset~|~\emptyset \vdash \int_{\ol
    K,F} : \Nat^{\Phi, \ol\alpha}\, F\, (\Lan^{\ol\alpha}_{\ol{K}}\,
  F) \ol{K}}\rho\,d\,\ol N\,\ol A\,y$ for all $\ol N$, $\ol A$, and
$y$, then $L$ would have to be the entirety of
$\mathit{Lan}_{\ol{\lambda \ol A.\, \setsem{\Gamma; \ol\alpha \vdash
      K}\rho {[\ol{\alpha := A} ]}}}\, \lambda \ol A.\,
\setsem{\Gamma; \Phi, \ol\alpha \vdash F}\rho {[\Phi, \ol \alpha :=
    \ol N, \ol A ]}$. An analogous result holds for relational
interpretations of $\Lan$-types.
