...
{\color{blue} Move statement of theorem earlier? Remove most of
  proof. Only interesting cases are var, app, and $\mu$-cases.} There
is a subtlety in the well-formedness rules for types.
