...
functors. However, since Pitts' semantics is operational rather than
categorical, any discussion of functoriality and cocontinuity is again
unnecessary and therefore absent.

There is, of course, a long line of work on categorical models of
parametricity for System F; see, for
example,~\cite{bfss??,dr??,has??,jab99,rr??,more}. Although the
present paper draws on this rich tradition, we emphasize that our
calculus does not have the impedicative polymorphism of full System
F. On the other hand, as far as we know all of the free theorems
derived in practice, even for ADTs, need only the polymorphism
