...
all models we know of are constructed using the categorical equivalent
of Atkey's approach, i.e., by verifying in the just-constructed
parametric model the existence of initial algebras for type
constructors obtained by reflecting back into syntax the functors
induced by the data types' Church encodings and supporting
self-related universal strengths. The present paper draws on this rich
tradition of categorical models of parametricity for System F, but
takes care to ensure that the functoriality needed to support
primitive nested types interacts nicely with System F's full
