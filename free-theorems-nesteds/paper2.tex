...
constructing parametric models for practical programming languages,
...
Cite Abel, MAtthes, and Uustalu --- reference 1 in our JFP nested types paper
...
function definitions in the usual way (as least fixpoints with
