...
\newcommand{\filtype}{\Nat^\emptyset 
  \, (\Nat^\emptyset \, \alpha \, Bool) (\Nat^\emptyset \, List \, \alpha \, List \, \alpha)}
...
\begin{thm} 
  ...
  $(s \circ g, s) \in \relsem{\alpha; \emptyset \vdash \Nat^\emptyset \alpha \, Bool} \rho$,
  and, for some well-formed term $filter$, \\
  $$t = \setsem{\alpha; \emptyset \,|\, \Delta \vdash filter : \filtype} \emph{, then }$$
  \begin{align*}
...
\begin{proof}
  ...
  Thus if 
  $(s, s') \in \relsem{\alpha; \emptyset \vdash \Nat^\emptyset \alpha \, Bool} \rho = \rho\alpha \to \Eq_{Bool}$,
  then 
  \begin{align*}
    (t (\pi_1 \rho) \,a \,p, t (\pi_2 \rho) \,b \,p) &\in \relsem{\alpha; \emptyset \vdash \Nat^\emptyset List \, \alpha \, List \, \alpha} \rho \\
