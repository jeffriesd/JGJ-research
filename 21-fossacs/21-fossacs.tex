...
{\color{red} It is given in detail in the accompanying anonymous
  supplementary material.} The proof reveals that if functorial
...
The IEL gives rise to an apppropriate Graph Lemma in the standard way:
...
of its term context to that of its type. These interpretations are
given in Figure~\ref{fig:term-sem}. 
...
The interpretations in Figure~\ref{fig:term-sem} respect
weakening, i.e., 
%, i.e., a term and its weakenings all have the same set and
%relational interpretations.
if $\rho \in \setenv$ then $\sem{\Gamma;\Phi \,|\, \Delta, x : F
